...
Both screenshots are live captures of the binary in this repo against
the maintainer's machine (13 active Claude Code sessions, ~95 M tokens
across them). They're regenerated by `docs/capture.sh`.
